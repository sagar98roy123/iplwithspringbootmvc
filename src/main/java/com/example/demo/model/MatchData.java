...
public class MatchData {
	...
	public MatchData(int id, String city, Date date, String player_of_match, String venue, String neutral_venue,
	...
	public String toString() {
		return "MatchData [id=" + id + ", city=" + city + ", date=" + date + ", player_of_match=" + player_of_match
